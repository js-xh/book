    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#butn").on("click",function(){
                $.ajax({
                    type:"get",
                    url:"${pageContext.request.contextPath}/book/selectScreenBookTypeName",
                    data:{
                    ...
                    success:function(data){
                        ...
                        console.log(data.pageList.list);
                        var li = "";
...
<div class="container-fluid">
    ...
    <%--	书的类型名称--%>
    <input id="typeName" type="hidden" value="${screenBook.typeName}">
    <%--	当前页数--%>
